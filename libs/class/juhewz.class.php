...
class wz{
	...
	private $appkey = ''; //申请的全国违章查询APPKEY
 
    private $cityUrl = 'http://v.juhe.cn/wz/citys';
 
    private $wzUrl = 'http://v.juhe.cn/wz/query';
 
    public function __construct($appkey = '0c42651c9962bcb5994a38390402108d'){
        $this->appkey = $appkey;
    }
     ...
     * @return  array 返回违章信息
     */
    public function query($city,$carno,$engineno='',$classno='', $isJson = true){
        $params = array(
            'key' => $this->appkey,
            'city'  => $city,
            'hphm' => $carno,
