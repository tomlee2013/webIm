<?php
	...
	*/
	class FileUpload {	
		...
		private $maxsize = 5242880;  					//限制文件上传大小（字节）
		...
		public function resize($srcImage,$toFile,$maxWidth = 480,$imgQuality=100) 
		{ 
   
			list($width, $height, $type, $attr) = getimagesize($srcImage); 
			
			$rate = $maxWidth/$width;                               //计算绽放比例
			$maxHeight = floor($height*$rate);
    		...
    		$scale = min($maxWidth/$width, $maxHeight/$height); //求出缩放比例 
